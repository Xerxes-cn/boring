...
class Config(SanicConfig):
    ...
    def __init__(
            ...
            oas_path_to_redoc_html: t.Optional[str] = None,
            oas_path_to_swagger_html: t.Optional[str] = None,
            oas_ui_default: t.Optional[str] = "redoc",
            ...
            swagger_ui_configuration: t.Optional[t.Dict[str, t.Any]] = None,
            trace_excluded_headers: t.Sequence[str] = ("authorization", "cookie"),
            **kwargs
    ):
        self.CORS = cors
...
def add_fallback_config(
        app: Sanic, config: t.Optional[Config] = None, **kwargs
) -> Config:
    if config is None:
